                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden transform -rotate-1 hover:rotate-0 transition duration-300">
                    ...
                    <div className="p-6 text-sm">
                        <div className="text-slate-600 leading-relaxed bg-slate-50 p-4 rounded-lg border border-dashed border-slate-200">
                            "Bonjour, suite aux optimisations sur la Search Console, les impressions grimpent de 12%..."
                        </div>
                    </div>
                </div>
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            <div className="bg-slate-800/60 border border-slate-700/50 p-4 rounded-xl flex items-start gap-4 hover:bg-slate-800 transition">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-300 text-sm">Pour <span className="text-white font-bold underline decoration-emerald-400">100€ investis</span>, vos campagnes ont généré <span className="text-white font-bold bg-slate-700 px-1.5 py-0.5 rounded">280€ net</span> de ventes directes.</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-slate-800/60 border border-slate-700/50 p-4 rounded-xl flex items-start gap-4 hover:bg-slate-800 transition">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-300 text-sm">Vos publicités captent l'attention (+12%). Seul point à surveiller : les visiteurs quittent le site un peu trop vite.</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-slate-800/60 border border-slate-700/50 p-4 rounded-xl flex items-start gap-4 hover:bg-slate-800 transition">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-300 text-sm">Nous modifions l'accroche de votre page d'accueil pour que les clients trouvent tout de suite ce qu'ils cherchent.</p>
                                </div>
                            </div>
                        </div>
