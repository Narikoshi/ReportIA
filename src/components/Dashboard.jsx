        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-gray-100 text-center relative overflow-hidden">
            ...
            <div className="flex flex-col gap-2">
              <button onClick={() => { window.location.href = "https://buy.stripe.com/test_8x28wRfE2dx7fEcaqQ1VK01"; }} className="w-full py-3 text-xs font-bold uppercase tracking-widest text-[#FDFBF7] bg-[#1A1F26] hover:bg-[#C5A880] transition-colors rounded-lg shadow-md">
                Passer Pro — 19€/mois
              </button>
